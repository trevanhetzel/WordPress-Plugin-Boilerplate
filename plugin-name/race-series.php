...
function activate_race_series() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-race-series-activator.php';
	Race_Series_Activator::activate();
}

// Runs during plugin deactivation
function deactivate_race_series() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-race-series-deactivator.php';
...
require plugin_dir_path( __FILE__ ) . 'includes/class-race-series.php';
