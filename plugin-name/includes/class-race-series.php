...
class Race_Series {
	...
	private function load_dependencies() {
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-race-series-loader.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-race-series-admin.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-race-series-public.php';
